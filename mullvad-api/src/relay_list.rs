...
impl ServerRelayList {
    ...
    fn add_bridge_relays(
        ...
        relay_list::BridgeEndpointData { shadowsocks: bridges.shadowsocks }
    }
}
...
fn into_mullvad_relay(relay: Relay, location: location::Location, endpoint_data: relay_list::RelayEndpointData) -> relay_list::Relay {
    relay_list::Relay {
...
impl WireGuardRelay {
    fn into_mullvad_relay(self, location: location::Location) -> relay_list::Relay {
        into_mullvad_relay(self.relay, location, relay_list::RelayEndpointData::Wireguard(relay_list::WireguardRelayEndpointData {
